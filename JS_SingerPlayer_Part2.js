...
const backgroundTexture = textureLoader.load('metal.jpg'); // Especifica la ruta a tu imagen
scene.background = backgroundTexture; // Asignar la textura como fondo

// Cargar el archivo MTL primero para el escenario
const mtlLoader = new MTLLoader();
mtlLoader.load('escenario 3/metalmariostage.mtl', function (materials) {
    ...
    objLoader.load('escenario 3/metalmariostage.obj', function (object) {
        scene.add(object); // Añadir el escenario a la escena
        object.position.set(2, -0.1, 4); // Ajustar posición si es necesario
