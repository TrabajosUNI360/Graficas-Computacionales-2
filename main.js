...
mtlLoader.load('escenario/tutorial_stage.mtl', function (materials) {
    ...
    objLoader.load('escenario/tutorial_stage.obj', function (object) {
        scene.add(object); // Añadir el escenario a la escena
        object.position.set(2, 0, 2.5); // Ajustar posición si es necesario
